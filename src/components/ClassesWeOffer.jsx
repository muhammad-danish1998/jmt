  ...
  const classesData = [
    {
      id: 'class-ix',
      title: 'Class IX',
      badge: 'Matric / SSC Part I',
      icon: BookOpen,
      description: 'Build a strong academic foundation with your chosen group under Ziauddin Board.',
    ...
    },
    {
      id: 'class-x',
      title: 'Class X',
      badge: 'Matric / SSC Part II',
      icon: Layers,
      description: 'Rigorous board exam preparation, fast-track support, and practical labs.',
      subjects: ['Science Group', 'Computer Science Group', 'General Group'],
    ...
    },
    {
      id: 'class-xi',
      title: 'Class XI',
      badge: 'Intermediate / HSSC Part I',
      icon: Compass,
      description: 'Specialized disciplines for higher education and career excellence.',
      subjects: [
        'FSC Pre-Medical',
        'FSC Pre-Engineering',
        'ICS (General Science)',
    ...
    },
    {
      id: 'class-xii',
      title: 'Class XII',
      badge: 'Intermediate / HSSC Part II',
      icon: Award,
      description: 'Final board examination preparation and university entrance coaching.',
      subjects: [
        'FSC Pre-Medical',
        'FSC Pre-Engineering',
        'ICS (General Science)',
